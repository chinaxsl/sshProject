function SelectTag(t){
    ...
    $.extend(
        ...
        _bindEvent:function(){
                var t=this;
                $(t.child).click(function(e){e.preventDefault();
